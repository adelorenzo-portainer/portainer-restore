...
--data '{"accessKeyID": "portainer", "bucketName": "kubernetes1",  "filename": "portainer-backup_2023-05-17_00-55-00.tar.gz",  "password": "",  "region": "us-east-1",  "s3CompatibleHost": "http://192.168.10.1:9002",  "secretAccessKey": "HmLzJ3evHclFoG4w"}'
